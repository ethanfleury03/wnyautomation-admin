...
- Admin logout and non-admin lockout exits send users to `NEXT_PUBLIC_CLIENT_LOGIN_URL`, defaulting to `https://app.wnyautomation.com/sign-in?redirect_url=/launch`, so everyone lands on the single WNY Automation gateway login.
